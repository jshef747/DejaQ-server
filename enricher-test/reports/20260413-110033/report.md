...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| baseline_qwen_0_5b | 60 | 180 | 82.2% | 95.0% | 0.0686 | 0.1996 | 60.0% | 126.6 | 245.0 |
| v2_regex_gate | 60 | 180 | 78.9% | 89.4% | 0.0779 | 0.2644 | 100.0% | 80.7 | 240.6 |
...
| 2 | `carbon_capture` | deep_chain | Is it effective enough to matter? | Is carbon capture effective enough to significantly reduce atmospheric CO2? | Is it effective enough to matter? | 0.3553 |
| 3 | `react_vs_vue` | multi_reference | Which is more popular? | Is React or Vue more popular? | Which is more popular? | 0.3405 |
| 4 | `tcp_vs_udp` | multi_reference | When should I use each? | When should I use TCP vs UDP? | When should I use each? | 0.3290 |
| 5 | `ml_vs_deep_learning` | multi_reference | When should I use one over the other? | When should I use machine learning vs deep learning? | When should I use one over the other? | 0.3140 |
| 6 | `react_vs_vue` | multi_reference | Which is easier to learn? | Is React or Vue easier to learn? | Which is easier to learn? | 0.3075 |
| 7 | `sql_vs_nosql` | multi_reference | When should I use each? | When should I use SQL vs NoSQL databases? | When should I use each? | 0.3073 |
| 8 | `frontend_vs_backend` | multi_reference | Which pays more? | Does frontend or backend development pay more? | Which pays more? | 0.2845 |
| 9 | `machine_learning_supervised` | topic_continuation | Which is most commonly used? | Which type of machine learning is most commonly used in practice? | Which is most commonly used? | 0.2718 |
| 10 | `homo_sapiens_neanderthals` | deep_chain | Did we interbreed with them? | Did Homo sapiens interbreed with Neanderthals? | Did we interbreed with them? | 0.2640 |
| 11 | `aerobic_vs_anaerobic` | multi_reference | How long should I do each? | How long should aerobic vs anaerobic exercise sessions be? | How long should I do each? | 0.2570 |
| 12 | `frontend_vs_backend` | multi_reference | Which is easier to learn first? | Is frontend or backend development easier to learn first? | Which is easier to learn first? | 0.2449 |
| 13 | `vaccines` | pronoun_resolution | Who developed the first one? | Who developed the first vaccine? | Who developed the first one? | 0.2343 |
| 14 | `event_loop_internals` | deep_chain | How does it schedule tasks? | How does the event loop schedule async tasks? | How does it schedule tasks? | 0.2166 |
| 15 | `aerobic_vs_anaerobic` | multi_reference | Which burns more fat? | Does aerobic or anaerobic exercise burn more fat? | Which burns more fat? | 0.2134 |
| 16 | `ml_vs_deep_learning` | multi_reference | Which is harder to implement? | Is machine learning or deep learning harder to implement? | Which is harder to implement? | 0.2121 |
| 17 | `python_vs_java` | multi_reference | Which one should I learn first? | Should I learn Python or Java first? | Which one should I learn first? | 0.2082 |
| 18 | `greek_mythology` | topic_continuation | How about Athena? | Who is Athena in Greek mythology? | What about Athena? | 0.2020 |
| 19 | `cats_vs_dogs` | multi_reference | Which is easier to care for? | Are cats or dogs easier to care for? | Which is easier to care for? | 0.2006 |
| 20 | `art_movements` | topic_continuation | What about Cubism? | What is the Cubism art movement? | What about Cubism? | 0.1996 |
